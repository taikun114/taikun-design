...
loading={"eager"}
fetchPriority={"high"}
className={`w-image c1uhg4lu c1r6gls1 choxsbt cxmjziy c1jbuqru c1xa9i4n cwuyehs c1d0k284 c58tzbx`} />
<AnimateChildren
...
{"Apple enthusiast / collector, graphic designer, blogger, etc..."}
</p>
</div>
</div>
<Box
...
<p
className={`w-element cg5mfwo c1tr50rt ckagbgx ctv6apc`}>
{"I explain Apple product related geeky information in greater detail and more clearly than anyone else, and recommend apps. (Available in Japanese only)"}
</p>
</div>
</div>
<Box
...
<p
className={`w-element cg5mfwo c1tr50rt ckagbgx ctv6apc`}>
{"I provide detailed information on smart home technology and lifestyle topics from a geeky perspective and the viewpoint of a person with a physical disability. (Available in Japanese only)"}
</p>
</div>
</div>
<Box
...
<p
className={`w-element cg5mfwo c1tr50rt ckagbgx ctv6apc`}>
{"I loosely share various information such as my thoughts, things I want to share, and random ideas that pop into my head, regardless of genre. (Available in Japanese only)"}
</p>
</div>
</div>
<Box
...
<p
className={`w-element cg5mfwo c1tr50rt ckagbgx ctv6apc`}>
{"A productivity app for Mac that lets you set up past copy history and your favorite standard phrases for easy recall."}
</p>
</div>
</div>
<Box
...
<p
className={`w-element cg5mfwo c1tr50rt ckagbgx ctv6apc`}>
{"A utility app for Mac, iPhone, iPad, and Apple Vision Pro that connects to and manages servers running the open-source LLM tool “Ollama”."}
</p>
</div>
</div>
<Box
...
<p
className={`w-element cg5mfwo c1tr50rt ckagbgx ctv6apc`}>
{"Brave Browser users can send tips via the Brave Rewards icon next to the address bar. For details, please see here."}
</p>
</div>
</div>
<Box
...
<p
className={`w-element cg5mfwo c1tr50rt ckagbgx ctv6apc`}>
{"You can support me from a cup of green tea using Buy Me a Coffee."}
</p>
</div>
</div>
<Box
...
<p
className={`w-element cg5mfwo c1tr50rt ckagbgx ctv6apc`}>
{"If you have a PayPal account, you can support me directly."}
</p>
</div>
</div>
<Box
