...
<HtmlEmbed
code={"<h2>ウェブサイトが収集する情報について</h2>\n<p>当ウェブサイトでは、アクセス解析ツールとして「Umami」を使用しています。これらの収集するトラフィックデータは匿名であり、個人を特定するものではありません。</p>\n<h3>Umami</h3>\n<p>Umamiでは、トラフィックデータの収集にCookieを使用していません。そのため、トラフィックデータの収集を拒否したい場合は<a href=\"https://umami.is/docs/exclude-my-own-visits\" target=\"_blank\" data-umami-event=\"umami-docs-link\" data-umami-event-region=\"ja\"><strong>こちらのドキュメント</strong></a>をご覧ください。<br>\nUmamiの規約に関しては、<a href=\"https://umami.is/privacy\" target=\"_blank\" data-umami-event=\"umami-privacy-link\" data-umami-event-region=\"ja\"><strong>こちら</strong></a>のページをご確認ください。</p>\n"}
